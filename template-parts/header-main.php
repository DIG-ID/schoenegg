<a class="skip-link" href="#main-content"><?php esc_html_e( 'Skip to main content', 'hs' ); ?></a>
<header id="header-main" class="header-main fixed w-full left-0 top-0 lg:bottom-0 lg:w-auto lg:min-w-64 lg:max-w-64 bg-white lg:border-r lg:border-r-gold transition-all duration-500 ease-in-out border-b border-b-gold lg:border-b-0 z-10" itemscope itemtype="https://schema.org/WebSite">
	<nav class="navigation-main relative flex w-full justify-between items-center h-16 lg:h-auto px-8 sm:px-11 lg:flex-col lg:justify-start lg:items-start lg:py-12 lg:px-8 " aria-label="<?php esc_attr_e( 'main navigation', 'hs' ); ?>">
		...
		<div class="menu-wrapper absolute w-full top-16 left-0 h-svh lg:h-auto px-8 sm:px-11 lg:px-0 lg:relative lg:top-auto lg:left-auto hidden bg-white lg:block">
			<?php
			wp_nav_menu(
				array(
		...
		<button class="mobile-menu-toggle" aria-label="<?php esc_attr_e( 'Toggle navigation', 'hs' ); ?>" aria-expanded="false" aria-controls="main-menu">
