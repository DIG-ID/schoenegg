	...
	<div class="hs-container">
		<div class="hs-grid">
			...
			<div class="col-span-1 md:col-span-5">
				...
				if ( get_field( 'contacts_whatsapp' ) ) :
				?>
					<div class="text__area"><p><?php esc_html_e( 'Whatsapp: ', 'hs' ) ?><a class="!no-underline !text-[#737373]" href="https://wa.me/<?php echo esc_attr( $wm ); ?>" target="_blank"><?php the_field( 'contacts_whatsapp' ); ?></a><br><?php esc_html_e( '(07:00 – 17:00 Uhr)', 'hs' ); ?></p></div>
				<?php endif; ?>
				<?php if ( get_field( 'contacts_fax' ) ) : ?>
					<div class="text__area"><p><?php esc_html_e( 'Fax: ', 'hs' ) ?><?php the_field( 'contacts_fax' ); ?></p></div>
				<?php endif; ?>
				<?php if ( get_field( 'contacts_e-mail' ) ) : ?>
				...
				<?php endif; ?>
				<?php if ( get_field( 'contacts_host_name' ) ) : ?>
