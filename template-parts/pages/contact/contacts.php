	...
	<div class="hs-container">
		<div class="hs-grid">
			...
			<div class="col-span-1 md:col-span-5">
				...
				<div class="text__area"><p><?php esc_html_e( 'Whatsapp: ', 'hs' ) ?><a class="!no-underline !text-[#737373]" href="https://wa.me/<?php the_field( 'contacts_whatsapp' ); ?>"><?php the_field( 'contacts_whatsapp' ); ?></a><br><?php esc_html_e( '(07:00 – 17:00 Uhr)', 'hs' ); ?></p></div>
